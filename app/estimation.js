...
function BigCard({ active, onClick, icon, label, subtitle, xs }) {
  return (
    <button
      ...
      {icon && (
        <div style={{ width: xs ? 48 : 64, height: xs ? 48 : 64, borderRadius: "50%", background: active ? C.cyan : "rgba(36,175,197,0.12)", display: "flex", alignItems: "center", justifyContent: "center", color: active ? "#fff" : C.cyan, transition: "all .2s" }}>
          {icon}
        </div>
      )}
      <div>
  ...
  return (
    <div style={{ display: "flex", gap: 12, marginTop: xs ? 24 : 36, flexDirection: xs ? "column" : "row" }}>
      <button
        ...
        style={{ flex: xs ? "none" : 1, width: xs ? "100%" : "auto", height: xs ? 56 : 52, borderRadius: 12, border: "none", background: nextDisabled ? "#bdbdbd" : C.cyan, color: "#fff", fontFamily: "Urbanist, sans-serif", fontSize: xs ? 17 : 16, fontWeight: 600, cursor: nextDisabled || sending ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "background .2s" }}>
      ...
      {showBack && (
        <button
          type="button"
          onClick={onBack}
          style={{ flex: "none", width: xs ? "100%" : "auto", height: xs ? 52 : 52, padding: "0 22px", borderRadius: 12, border: `1px solid ${C.cinder15}`, background: "transparent", color: C.abbey, fontFamily: "Urbanist, sans-serif", fontSize: 15, fontWeight: 500, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
      ...
      <main style={{ paddingTop: m.xs ? 72 : m.mob ? 80 : 120, background: C.bg, minHeight: "100vh" }}>
        <section style={{ padding: `${m.xs ? 32 : 60}px ${px} ${m.xs ? 60 : 100}px`, maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: m.xs ? 32 : 48 }}>
            <span style={{ display: "inline-block", padding: "6px 16px", background: "rgba(36,175,197,0.12)", color: C.cyan, borderRadius: 99, fontSize: m.xs ? 12 : 13, fontWeight: 600, letterSpacing: 0.5, marginBottom: m.xs ? 16 : 20, textTransform: "uppercase" }}>
              Estimation gratuite
            </span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: m.xs ? "1fr" : "repeat(3, 1fr)", gap: m.xs ? 16 : 24, marginTop: m.xs ? 32 : 56, maxWidth: 900, marginLeft: "auto", marginRight: "auto" }}>
            {[
              ...
              <div key={i} style={{ display: "flex", gap: 14, alignItems: "center", padding: m.xs ? 16 : 20, background: "#fff", borderRadius: 14 }}>
                <div style={{ width: 44, height: 44, borderRadius: "50%", background: "rgba(36,175,197,0.12)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
