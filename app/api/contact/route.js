    ...
    const { error } = await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
          ...
          ${reference || typeBien ? `
          <div style="background: #09261D; border-radius: 8px; padding: 14px 18px; margin-bottom: 24px; display: flex; align-items: center; gap: 12;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            ${message ? `<tr><td colspan="2" style="background: #f5f5f5; padding: 10px 14px; font-weight: bold; color: #09261D;">Message</td></tr><tr><td colspan="2" style="padding: 10px 14px; border-bottom: 1px solid #eee; color: #222; white-space: pre-wrap;">${message}</td></tr>` : ""}
          </table>
